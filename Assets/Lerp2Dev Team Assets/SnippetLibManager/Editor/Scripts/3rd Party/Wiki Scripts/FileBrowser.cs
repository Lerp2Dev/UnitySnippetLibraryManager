...
public class FileBrowser
{
    ...
    public FileBrowser(EditorWindow window, FileBrowserType browserType, string name, FinishedCallback callback)
    {
        m_window = window;
        m_name = name;
    ...
    public FileBrowser(Rect _screenRect, FileBrowserType browserType, string name, FinishedCallback callback)
    {
        m_name = name;
